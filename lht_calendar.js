...
function calCaption(calDate){
    ...
    //this determines the current month 
...
function calWeekdayRow(){
   //array to hold the weekday abbreviations
...
function daysInMonth(calDate){
   ...
   //extract the four digit year abd month values
   var thisYear = calDate.getFullYear();

   //revise the dayCount for leap years
   if(thisYear % 4 === 0){
